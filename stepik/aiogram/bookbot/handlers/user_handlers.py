...
from stepik.aiogram.bookbot.database.database import user_dict_template, users_db
from stepik.aiogram.bookbot.filters.filters import IsDelBookmarkCallbackData, IsDigitCallbackData
from stepik.aiogram.bookbot.keyboards.bookmarks_kb import create_bookmarks_keyboard, create_edit_keyboard
from stepik.aiogram.bookbot.keyboards.pagination_kb import create_pagination_keyboard
from stepik.aiogram.bookbot.lexicon.lexicon import LEXICON
...
# Этот хэндлер будет срабатывать на нажатие инлайн-кнопки
# с закладкой из списка закладок и удалению
